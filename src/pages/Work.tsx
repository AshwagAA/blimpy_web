    ...
    <div style={bg}>
      <section style={{ padding: 'clamp(100px, 15vw, 160px) clamp(16px, 3vw, 30px) 80px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: '1296px' }}>
          <h1 style={{ fontFamily: 'Funnel Display', fontSize: 'clamp(48px, 10vw, 134px)', lineHeight: '0.9', letterSpacing: '-0.04em', marginBottom: '20px' }}>Featured <em style={{ fontFamily: 'Funnel Display', fontStyle: 'italic' }}>Work</em></h1>
    ...
    <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', margin: 0 }}>{tags.join(' • ')}</p>
      ...
      <section style={{ padding: 'clamp(60px, 12vw, 140px) clamp(16px, 3vw, 30px) clamp(100px, 15vw, 180px)', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: '760px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '32px', textAlign: 'center' }}>
          ...
          <Link to="/contact" className="ghost-cta" style={{ textDecoration: 'none', color: '#ff1f00', fontSize: '16px', border: '1px solid rgba(255,255,255,0.3)', padding: '14px 28px' }}>[ Contact Us ]</Link>
        </div>
      </section>
    </div>
  )
    ...
    <div style={bg}>
      <section style={{ padding: 'clamp(100px, 15vw, 160px) clamp(16px, 3vw, 30px) 80px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: '900px' }}>
          <Link to="/work" style={{ color: 'rgba(255,255,255,0.55)', fontSize: '16px', textDecoration: 'none' }}>← Back to Work</Link>
          <span style={{ display: 'block', fontSize: '16px', color: 'rgba(255,255,255,0.55)', letterSpacing: '0.05em', marginTop: '32px' }}>{item.num}</span>
          ...
          <Link to="/contact" className="ghost-cta" style={{ display: 'inline-block', marginTop: '32px', textDecoration: 'none', color: '#fff', fontSize: '16px', border: '1px solid rgba(255,255,255,0.3)', padding: '12px 24px' }}>[ Get in touch ]</Link>
        </div>
      </section>
    </div>
  )
