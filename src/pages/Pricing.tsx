...
import { bg, solidCtaStyle } from '../lib/shared'

const ctaStyle: React.CSSProperties = { ...solidCtaStyle, display: 'block', padding: '16px 24px' }
    ...
    <div style={bg}>
      <section style={{ padding: 'clamp(100px, 15vw, 160px) clamp(16px, 3vw, 30px) 80px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: '1296px' }}>
          <h1 style={{ fontFamily: 'Funnel Display', fontSize: 'clamp(48px, 10vw, 134px)', lineHeight: '0.9', letterSpacing: '-0.04em', marginBottom: '20px' }}>Our <em style={{ fontFamily: 'Funnel Display', fontStyle: 'italic' }}>Pricing</em></h1>
